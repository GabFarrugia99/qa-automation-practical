...
- Name: User Profile Form Validation (BDD Gherkin Style) >> Valid mandatory fields
- Location: C:\Users\gab14\OneDrive\Documents\qa-automation-bdd\tests\userProfileForm.spec.ts:6:7
...
Expected: ""
Received: "LinkedIn must be filled out"
    at FormStep.then_i_should_not_see_a_dialog (C:\Users\gab14\OneDrive\Documents\qa-automation-bdd\steps\form.step.ts:67:32)
    at C:\Users\gab14\OneDrive\Documents\qa-automation-bdd\tests\userProfileForm.spec.ts:15:16
```
...
- textbox "First Name (mandatory):": Jane
- text: "Last Name (mandatory):"
- textbox "Last Name (mandatory):": Doe
- text: "Email (mandatory):"
- textbox "Email (mandatory):": jane@example.com
- text: "Password (mandatory):"
- textbox "Password (mandatory):": Test123!
- text: "Confirm Password (mandatory):"
- textbox "Confirm Password (mandatory):": Test123!
